...
Dernière mise à jour : 2026-06-22 (scission + enrichissement feedback : comparaison-nombres → 5h6h + 7h8h)  
...
| comparaison-nombres-7h8h.html | Le comparateur de nombres (7H-8H) | ✅ | ❌ | Nouvelle app (7H-8H, MSN 22). Issue de la décision de scission. N1 = 1000–9999 (4 chiffres) · N2 = 10000–99999 (5 chiffres). Carte ajoutée dans index.html (animation-delay 180ms). `TYPE_TACHE='drill'` + `buildMsg` (rangs jusqu'à `dizaines de milliers`). `.digit.ten-thousands` (rang 4, couleur `var(--color-tens)`) + `renderLegend` étendu. Pas encore audité v2 (créée lors de la mise en œuvre des décisions Isaac, pas d'un audit propre). |
